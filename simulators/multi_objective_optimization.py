...
def run_tunning(param1, param2, param3, param4, param5, param6):
    # Run the simulation with the given parameters
    success_rate, execution_time, avg_fee = run_simulation(1000, 50, 3, param1, param2, param3, param4, param5, param6)
...
def objective(trial):
    ...
    param5 = trial.suggest_float("param5", 0.0, 0.5)
    param6 = trial.suggest_int("param6", 0, 5)
    result1, result2 = run_tunning(param1, param2, param3, param4, param5, param6)
